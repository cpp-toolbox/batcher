...
TransformVWithTexturesShaderBatcher::TransformVWithTexturesShaderBatcher(ShaderCache& shader_cache) : shader_cache(shader_cache) {
...
void TransformVWithTexturesShaderBatcher::queue_draw(const std::vector<unsigned int> &indices, const std::vector<glm::vec3> &positions, const std::vector<glm::vec2> &texture_coordinates) {
    ...
    texture_coordinates_this_tick.insert(texture_coordinates_this_tick.end(), texture_coordinates.begin(), texture_coordinates.end());
